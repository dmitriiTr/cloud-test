  ...
  return <nav className="bg-white border-gray-200">
    <div className="justify-between p-4">
      <div className="w-full">
        <ul className="flex font-medium p-0  border-gray-100 rounded-lg space-x-8 rtl:space-x-reverse flex-row
         mt-0 border-0 bg-white">
          <li>
            <NavLink
              className="block py-2 px-3 text-gray-900 rounded bg-transparent p-0 hover:text-blue-700" to="/">
              About
            </NavLink>
          </li>
          <li ref={menu}>
